  ...
  <v-app-bar app fixed dense>
    ...
    <v-menu v-if="isAuthenticated && isGlobalAdmin" offset-y>
      ...
      <v-list>
        ...
        <v-list-item @click="$router.push(localePath('/perspective/edit'))">
          <v-list-item-title>Edit</v-list-item-title>
        </v-list-item>
        <v-list-item @click="$router.push(localePath('/perspective/list'))">
          <v-list-item-title>List</v-list-item-title>
        </v-list-item>
        <v-list-item @click="$router.push(localePath('/perspective/delete'))">
          <v-list-item-title>Delete</v-list-item-title>
        </v-list-item>
        <v-list-item @click="$router.push(localePath('/perspective/associate'))">
