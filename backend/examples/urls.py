...
from .views.example import ExampleDetail, ExampleList, ExampleResolveAPI
...
urlpatterns = [
    ...
    path('examples/<int:example_id>/resolve', ExampleResolveAPI.as_view(), name='example_resolve'),
]
